  ...
  $(function() {
    ...
    calculate_menu();
        ...
        $('.dropdown-toggle').click(function(){
            ...
            $(this).find('i:last-child').toggleClass('rotate-180');
            return false;
        });
        ...
        $(function(){
            $(".all-one a").slice(0, 10).show(); // select the first ten
            $(".load-more-thumbs-one").click(function(e){ // click event for load more
                e.preventDefault();
                $(".all-one a:hidden").slice(0, 2).show(0); // select next 10 hidden divs and show them
                if($(".all-one a:hidden").length == 0){ // check if any hidden divs still exist
                    $(this).hide();
                }
            });
        });
         ...
         //Loading Thumb Layout for News, 10 articles at a time
        $(function(){
            $(".all-two a").slice(0, 10).show(); // select the first ten
            $(".load-more-thumbs-two").click(function(e){ // click event for load more
                e.preventDefault();
                $(".all-two a:hidden").slice(0, 2).show(0); // select next 10 hidden divs and show them
                if($(".all-two a:hidden").length == 0){ // check if any hidden divs still exist
                    $(this).hide();
                }
            });
        });
